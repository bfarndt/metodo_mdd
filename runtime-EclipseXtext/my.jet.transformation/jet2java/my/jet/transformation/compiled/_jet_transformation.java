...
public class _jet_transformation implements JET2TemplateLoader,
    ...
    static {
        ...
        pathToTemplateOrdinalMap.put("templates/main.jet", //$NON-NLS-1$
                Integer.valueOf(1));
        pathToTemplateOrdinalMap.put("templates/templateExemplo.jet", //$NON-NLS-1$
                Integer.valueOf(2));
    }
        ...
        if(ordinal != null) {
           switch (ordinal.intValue()) {
            case 0: // templates/dump.jet
                return new my.jet.transformation.compiled._jet_dump(templatePath);
            case 1: // templates/main.jet
                return new my.jet.transformation.compiled._jet_main(templatePath);
            case 2: // templates/templateExemplo.jet
                return new my.jet.transformation.compiled._jet_templateExemplo(templatePath);
            default:
                break;
            }
        }
