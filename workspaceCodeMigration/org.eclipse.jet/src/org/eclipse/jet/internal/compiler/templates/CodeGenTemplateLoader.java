        ...
        if(ordinal != null) {
           switch (ordinal.intValue()) {
            case 0: // templates/jet2java.jet
                return new org.eclipse.jet.internal.compiler.templates.JET2JavaGenerator(templatePath);
            case 1: // templates/jet2transform.jet
                return new org.eclipse.jet.internal.compiler.templates.JET2TransformGenerator(templatePath);
            case 2: // templates/jetTemplateMap.properties.jet
                return new org.eclipse.jet.internal.compiler.templates.JETTemplateMapGenerator(templatePath);
            case 3: // templates/main.jet
                return new org.eclipse.jet.internal.compiler.templates.DummyMain(templatePath);
            case 4: // templates/tagDataDeclarations.jet
                return new org.eclipse.jet.internal.compiler.templates.TagDataDeclGenerator(templatePath);
            case 5: // templates/v1/jet2java.jet
                return new org.eclipse.jet.internal.compiler.templates.v1.JET1JavaGenerator(templatePath);
            case 6: // templates/v2/jet2java.jet
                return new org.eclipse.jet.internal.compiler.templates.v2.JET2JavaGeneratorNew(templatePath);
            case 7: // templates/writeJavaExpression.jet
                return new org.eclipse.jet.internal.compiler.templates.WriteJavaExpressionTemplate(templatePath);
            case 8: // templates/writeTextElement.jet
                return new org.eclipse.jet.internal.compiler.templates.WriteTextElementTemplate(templatePath);
            case 9: // templates/xmlEnd.jet
                return new org.eclipse.jet.internal.compiler.templates.XMLEndGenerator(templatePath);
            case 10: // templates/xmlStart.jet
                return new org.eclipse.jet.internal.compiler.templates.XMLStartGenerator(templatePath);
            default:
                break;
            }
        }
