...
<html lang="en">
  ...
  <body role="document">
	      ...
	      <div class="container">
	        ...
	        <div id="navbar" class="navbar-collapse collapse">
	          <ul class="nav navbar-nav">
	            	...
	            	<li class="active"><a href="/pageDaniel.php">
	...
	<div class="panel panel-default">
		<div class="panel-heading">Novo Daniel</div>
		<div class="panel-body">
			<form class="bs-example bs-example-form" data-example-id="simple-input-groups" action="/Daniel/save.php" method="post">
				<input type="hidden" name="pageBack" value="pageDaniel">
