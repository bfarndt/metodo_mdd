...
public class _jet_templateBootstrapdatepicker implements JET2Template {
    private final String templateFile;

    public _jet_templateBootstrapdatepicker(String templateFile) {
        super();
