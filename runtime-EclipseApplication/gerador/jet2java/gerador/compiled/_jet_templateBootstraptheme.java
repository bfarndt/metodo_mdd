...
public class _jet_templateBootstraptheme implements JET2Template {
    private final String templateFile;

    public _jet_templateBootstraptheme(String templateFile) {
        super();
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(NL);         
        out.write("  .navbar .navbar-nav .open .dropdown-menu > .active > a,");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("  .navbar .navbar-nav .open .dropdown-menu > .active > a:hover,");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("  .navbar .navbar-nav .open .dropdown-menu > .active > a:focus {");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write(NL);         
        out.write(".list-group-item.active:hover .badge,");  //$NON-NLS-1$        
        out.write(NL);         
        out.write(".list-group-item.active:focus .badge {");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("  text-shadow: none;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("}");  //$NON-NLS-1$        
        ...
        out.write("}");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("/*# sourceMappingURL=bootstrap-theme.css.map */");  //$NON-NLS-1$        
        out.write(NL);         
        out.popTemplateFile();
    }
}
