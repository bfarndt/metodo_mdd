...
public class _jet_bootstrapcss implements JET2Template {
    ...
    private static final TagInfo _td_c_include_3380_1 = new TagInfo("c:include", //$NON-NLS-1$
            3380, 1,
            new String[] {
                "template", //$NON-NLS-1$
            },
            new String[] {
                "templates/CSS/bootstrap2.css.jet", //$NON-NLS-1$
            } );
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write("}");  //$NON-NLS-1$        
        out.write(NL);         
        out.setTag("include",64219,64276);
// elemento tipo XMLEmptyElement3(org.eclipse.jet.core.parser.ast.XMLEmptyElement)
out.jump(57);
        out.includeStart();
        RuntimeTagElement _jettag_c_include_3380_1 = context.getTagFactory().createRuntimeTag(_jetns_c, "include", "c:include", _td_c_include_3380_1); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_include_3380_1.setRuntimeParent(null);
        _jettag_c_include_3380_1.setTagInfo(_td_c_include_3380_1);
        _jettag_c_include_3380_1.doStart(context, out);
        _jettag_c_include_3380_1.doEnd();
        out.setTag(null,-1,-1);
        out.popTemplateFile();
    }
}
