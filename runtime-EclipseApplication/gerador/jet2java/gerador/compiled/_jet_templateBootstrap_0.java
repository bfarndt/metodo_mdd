...
public class _jet_templateBootstrap_0 implements JET2Template {
    private final String templateFile;
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_templateBootstrap_0(String templateFile) {
        super();
    ...
    private static final TagInfo _td_c_include_3323_1 = new TagInfo("c:include", //$NON-NLS-1$
            3323, 1,
            new String[] {
                "template", //$NON-NLS-1$
            },
            new String[] {
                "templates/CSS/templateBootstrap2.jet", //$NON-NLS-1$
            } );
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write("}");  //$NON-NLS-1$        
        out.write(NL);         
        out.setTag("include",63197,63258);
// elemento tipo XMLEmptyElement3(org.eclipse.jet.core.parser.ast.XMLEmptyElement)
out.jump(61);
        out.includeStart();
        RuntimeTagElement _jettag_c_include_3323_1 = context.getTagFactory().createRuntimeTag(_jetns_c, "include", "c:include", _td_c_include_3323_1); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_include_3323_1.setRuntimeParent(null);
        _jettag_c_include_3323_1.setTagInfo(_td_c_include_3323_1);
        _jettag_c_include_3323_1.doStart(context, out);
        _jettag_c_include_3323_1.doEnd();
        out.setTag(null,-1,-1);
        out.popTemplateFile();
    }
}
