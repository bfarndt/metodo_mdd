            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <!--<li><a href="/PageMedico.php">Cadastro de Médico</a></li>
                        <li><a href="/PagePaciente.php">Cadastro de Paciente</a></li>
                        <li><a href="/PageMedicamento.php">Cadastro de Medicamento</a></li>-->
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </nav>
