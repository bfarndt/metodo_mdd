...
public class JETProcess extends PlatformObject implements IProcess
{
  ...
  // Para armazenar o arquivo de mapeamento
  private final IResource mappingFile;
  private final IProgressMonitor monitor;
  private JET2Context context;
  private JETStreamsProxy streamsProxy;
  private final Map attributes = new HashMap();

  // Modificado por Daniel Lucr仕io
  // Para receber o arquivo de mapeamento como par盈etro
  //public JETProcess(ILaunch launch, String id, IResource resource, int logFilterLevel, IProgressMonitor monitor)
  public JETProcess(ILaunch launch, String id, IResource resource, IResource mappingFile, int logFilterLevel, IProgressMonitor monitor)
  {
    ...
    // Adicionado por Daniel Lucr仕io
    // Para inicializar o arquivo de mapeamento
  ...
  public void run() {
    ...
    try
    {
      ...
      if(descriptor != null)
      {
        ...
        // Adicionado por Daniel Lucr仕io
        // Para configurar o mapeamento na plataforma JET
        JET2Platform.initGeneratedCodeMap();
        
        status = JET2Platform.runTransform(id, context, monitor);
        
        // Adicionado por Daniel Lucr仕io
        // Para salvar o mapeamento
        JET2Platform.saveGeneratedCodeMap(mappingFile);
