...
public class JETLaunchConstants
{
  ...
  // Constante que representa a configuração do arquivo de mapeamento
  public static final String MAPPING_FILE = JET2Platform.PLUGIN_ID + "." + "mappingFile"; //$NON-NLS-1$ //$NON-NLS-2$
